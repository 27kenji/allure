...
public class Ex5 extends CoreTestCase2 {
    ...
    public void testSaveAndCompareTwoArticles() {
        ...
        if(Platform.getInstance().isMw()) {
            ...
            Assert.assertEquals("We are not on the same page", first_article_title, ArticlePageObject.getArticleTitle());
        }
        ...
        Assert.assertTrue("Unwatch button of the second article is not present after delete the first article", result);
    }
